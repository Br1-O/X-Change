export const homeContent = `
    ...
    stroke="var(--main-color)" stroke-width="0px" stroke-opacity="0.5" fill="var(--border-color)" fill-opacity="1" 
    ...
    <section class="trending-products" data-aos="zoom-in"  data-aos-offset="100" data-aos-duration="2000">
        ...
        <h2 class="subtitle"> ¡Otras ofertas en base a tus <span>intereses</span>!</h2>
